...
import {
  ConnTestRequest,
  ConnTestResult as ConnTestResultSchema,
  SecretsStatus as SecretsStatusSchema,
...
export default async function settingsRoutes(appBase: FastifyInstance) {
  ...
  app.get(
    '/settings',
    { schema: { response: { 200: SettingsSchema, ...ApiErrors } } },
    async (req) => {
  ...
  app.get(
    ...
    { schema: { response: { 200: SecretsStatusSchema, ...ApiErrors } } },
  ...
  app.put(
    '/settings',
    { schema: { body: SettingsUpdate, response: { 200: SettingsSchema, ...ApiErrors } } },
    async (req) => {
  ...
  app.post(
    '/settings/test-connection',
    {
      schema: {
        ...
        response: { 200: ConnTestResultSchema, ...ApiErrors },
      },
