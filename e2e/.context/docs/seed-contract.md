...
|---|---|---|---|
| `acme/payments-api` is the **first** repo | the only seeded repo | home redirect → `/repos/<id>/pulls` | 01, 02, 04, 05, 12 |
| `Add rate limiting to public API endpoints` | PR #482 title | `PRRow`, PR detail header | 02, 04, 05, 12 |
| `/pulls/482` | PR number | detail route | 02, 04, 05, 12 |
