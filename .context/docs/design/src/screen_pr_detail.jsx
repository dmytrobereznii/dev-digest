...
function RiskPillRow() {
  ...
  return React.createElement("div", null,
    React.createElement("div", { style: { display: "flex", gap: 7, flexWrap: "wrap" } },
      window.RISKS.map((r, i) => React.createElement("button", {
        key: i, onClick: () => setOpen(open === i ? null : i),
        style: { display: "inline-flex", alignItems: "center", gap: 6, padding: "5px 10px", borderRadius: 6, fontSize: 12, fontWeight: 500,
          border: "1px solid " + (open === i ? RISK_SEV[r.severity] : "var(--border)"), background: open === i ? "var(--bg-hover)" : "transparent",
    ...
    open != null && React.createElement("div", { style: { marginTop: 10, padding: "10px 12px", borderRadius: 7, border: "1px solid var(--border)", background: "var(--bg-surface)", animation: "ddpop .15s ease" } },
      ...
      React.createElement("div", { style: { display: "flex", gap: 6, marginTop: 8 } },
        window.RISKS[open].file_refs.map((fr, i) => React.createElement(window.MonoLink, { key: i }, fr)))));
}
...
function BriefCard({ blastView }) {
  return React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 16 } },
    React.createElement(window.VerdictBanner),
    React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 } },
      React.createElement(window.Card, null,
        ...
        React.createElement(RiskPillRow)),
      React.createElement(window.Card, null,
...
function OverviewTab({ blastView }) {
  return React.createElement("div", { style: { padding: "20px 28px 40px", maxWidth: 1080, margin: "0 auto" } },
    React.createElement("section", null,
      ...
      React.createElement(BriefCard, { blastView })));
}

function FilesTab() {
  return React.createElement("div", { style: { padding: "20px 28px 40px", maxWidth: 1080, margin: "0 auto" } },
    React.createElement(window.SectionLabel, { icon: "Code" }, "Reviewer-ordered diff"),
    React.createElement(window.SmartDiff));
}

function ScreenPRDetail({ blastView, h = 1100, composeOpen, tab = "overview" }) {
  ...
  return React.createElement(window.AppFrame, { active: "dashboard", h, crumb: [{ label: "acme/payments-api", mono: true }, { label: "Pull Requests" }, { label: "#482", mono: true }] },
    ...
    React.createElement("div", { style: { background: "var(--bg-primary)", borderBottom: "1px solid var(--border)" } },
    ...
    t === "overview" && React.createElement(OverviewTab, { blastView }),
    t === "runs" && React.createElement(window.AgentRunsTab),
    t === "files" && React.createElement(FilesTab));
}

Object.assign(window, { ScreenPRDetail, BriefCard, IntentBlock, RiskPillRow, HistoryAccordion, ComposeReviewDrawer });
